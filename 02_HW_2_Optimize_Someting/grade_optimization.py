...
Usage:
- Switch to a student feedback directory first (will write "points.txt "comments.txt" in pwd).
...
abs_margins = dict(sum_to_one=0.02, alloc_range=0.02, alloc_match=0.1)  # margin of error for each component
